...
class ForgeJudge:
    ...
    def __init__(self, api_key: Optional[str] = None, model_name: str = "gemini-1.5-flash", 
                 base_url: str = "https://api.tensorblock.co/v1"):
        """Initialize Forge judge with API key and model configuration."""
        ...
        self.cost_per_call = self.cost_estimates.get(model_name, 0.001)
        self.total_calls = 0
    
    def _call_judge(self, prompt: str, expected_check_id: str, max_retries: int = 2) -> Dict[str, Any]:
    ...
    def judge_traceability(self, data: Dict[str, Any], website_content: str) -> Dict[str, Any]:
        ...
        return self._call_judge(prompt, "L-1")
    ...
    def judge_actionability(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self._call_judge(prompt, "L-2")
    ...
    def judge_redundancy(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self._call_judge(prompt, "L-3")
    ...
    def judge_context_steering(self, data: Dict[str, Any], user_context: str, context_type: str) -> Dict[str, Any]:
        ...
        return self._call_judge(prompt, "L-4")
    ...
    def run_all_judges(self, data: Dict[str, Any], website_content: str, 
        ...
        # Calculate actual cost based on calls made
        calls_made = self.total_calls - initial_calls
        results["judge_calls_made"] = calls_made
        results["total_cost_estimate"] = calls_made * self.cost_per_call
...
def evaluate_with_llm_judges(output: str, input_vars: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        # Allow model switching via environment variable
        model_name = os.getenv("EVAL_MODEL", "gemini-1.5-flash")
        judge = ForgeJudge(model_name=model_name)
    ...
    if os.getenv("FORGE_API_KEY"):
        try:
            ...
            for model in models_to_test:
                ...
                # Set model for this test
                os.environ["EVAL_MODEL"] = model
                
                results = evaluate_with_llm_judges(sample_output, input_vars)
